...
function EvChargers() {
  ...
  const [title, setTitle] = useState(
    "EV Chargers | Transblue Facility Management"
  );
  const [meta, setMeta] = useState(
    "Transblue's facility management services can cut the time and headache of your EV charger project by providing personalized solutions to your unique project."
  );

  useEffect(() => {
    if (pathname === "/evchargers/contact") {
      setTitle("EV Chargers | Contact | Transblue Facility Management");
      setMeta(

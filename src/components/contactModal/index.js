                ...
                <div className="row">
                  <h3>
                    {props.location !== undefined
                      ...
                      : "TRANSBLUE GENERAL CONTRACTING"}
                  </h3>
                  <p className="section-p">
                    Transblue is a leading provider of construction management
                    services specializing in Multifamily, Residential and
                    Commercial Properties. Expect unmatched efficiency and
                    expertise for all property installations
                  </p>
                  <p className="section-p">
                    Transblue will help your property meet the requirements for
